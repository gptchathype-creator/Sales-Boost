...
exports.computeQualitySignal = computeQualitySignal;
...
function countOccurrences(text, tokens) {
    let count = 0;
...
function computeQualitySignal(message) {
...
//# sourceMappingURL=qualitySignal.js.map